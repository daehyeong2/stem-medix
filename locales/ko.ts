export default {
  ...
  routes: {
    ...
    goals: {
      title: "성장 목표",
      description: "Stem Medix의 사업화 추진 전략을 소개합니다.",
      contents: {
        "2024_the_first_half": {
          title: "2024년 상반기",
          target: "플랫폼 서비스 제공 및 고객 유치",
          list: {
            0: "혈관줄기세포 유효성 평가 플랫폼 구축",
            1: "홍보 프로모션 진행",
          },
        },
        "2024_second_half": {
          title: "2024년 하반기",
          target: "시제품 설계, 프로토타입 제작 및 고객유치",
          list: {
            0: "인공혈관 제작 및 교보재 활용",
            1: "Vessel on chip 제작",
            2: "신제품 홍보 ​프로모션 진행",
        ...
        2026: {
          title: "2026년",
          target: "외주 용역을 통한 시제품 제작 및 고객 유치",
          list: {
            0: "노화 억제용 배양배지 제작",
            1: "신제품 홍보 프로모션 진행",
          },
